...
def setup_pdf_parser(llm):
    ...
    retriever = vectorstore.as_retriever(
        search_type="similarity", search_kwargs={"k": 4, "include_metadata": True}
    )
...
class Tools:
    def __init__(self, llm):
        self.llm = llm
        self.qa = setup_pdf_parser(self.llm)
        self.tools = [
            Tool(
                name="python_repl",
            ...
            Tool(
                name="Aadhar UIDAI Information Tool",
